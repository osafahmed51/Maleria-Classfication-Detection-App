...
public class guidlinesCountries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guidlines_countries);
        ...
        recyclerView = findViewById(R.id.guidCountryrecycler);
